...
<head>
  ...
  <title>Yokemate Medicare</title><!-- Bootstrap core CSS -->
...
?>    <script type="text/javascript">
        ...
        if ($numrows == 1) {
            ...
            //store the result to session variables
  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        "font-weight: bold">Yokemate Medicare</a>
      </div>
...
<br>
                        <div class="col-lg-6">
                         <label for="user">Last name: </label>
                          <input class="form-control" id="lName" name="lName" placeholder=
                  ...
                  <div class="form-group" id="divremail">
                    <div class="rows">
                      <div class="col-md-12">
                        <div class="col-lg-12">
                        <label for="email">Re-email Id:   </label>
                          <input class="form-control" id="reemail" name="reemail"
...
<br>
            ...
            <label>Gender:   </label>
                        <div class="radio">
                          <label><input id="optionsRadios1" name="gender" type=
 ...
 <div class="form-inline">
            ...
            <label> Profession: </label>
                        <div class="radio">
                          <label><input id="optionsRadios1" name="profession" type=
