...
<div class="container">
      <div class="col-md-10 col-md-offset-1">
        <?php
          $db = new PDO('mysql:host=localhost; dbname=saibah_medicare;', 'root', '');
          $stmt = $db->prepare("SELECT id FROM comments WHERE content LIKE ? OR category LIKE ?");
          ...
          foreach ($result as $key => $value) {
            ...
            echo "<div class='panel-footer'>
              <div class='row'>
                <div class='col-md-1 hidden-xs'><div class='text-center'><img src='".getImagepath($_SESSION['member_id'])."' class='img-circle' height='40px' width='40px'/></div></div>
                <div class='col-md-11'>
